...
function render_expense(datai) {
  ...
  desc.className = "expense-description pure-u-lg-9-24 pure-u-2-3";
  cat.innerText = category;
  cat.className = "expense-category pure-u-lg-5-24 pure-u-1-3";
  acct.innerText = account;
  acct.className = "expense-acct pure-u-lg-5-24 pure-u-1-3";
  amt_inner.innerText = amount;
  amt_inner.className="expense-amt-inner";
  amt.className = "expense-amt pure-u-lg-3-24 pure-u-1-3";
  btns.className = "expense-btns pure-u-lg-2-24 pure-u-1-3";
  btns_inner.className="expense-btns-inner";
  edit.className = "fas fa-edit edit-btn";
  del.className = "fas fa-trash-alt del-btn";
